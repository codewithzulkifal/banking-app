...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      <div className=" flex justify-center items-center w-[200px] gap-3 cursor-pointer ">
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        {navLinks.map((nav, index) => (
          ...
          >
            <a href={`#${nav.id}`} className=" hover:text-white hover:font-semibold transition-all duration-300 " >{nav.title} </a>
          </li>
        ))}
      </ul>
